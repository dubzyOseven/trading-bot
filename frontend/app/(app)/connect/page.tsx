...
export default function ConnectPage() {
  ...
  const showForm = !brokerLoading && status !== null && !status.connected;
  const showConnected = !brokerLoading && status?.connected;
      ...
      <main className="max-w-lg mx-auto px-4 py-10">
        ...
        {showConnected && status && (
          <div className="bg-gray-900 border border-green-800 rounded-2xl p-6 mb-6">
            ...
            {success && (
              <p className="text-success text-sm mt-3">{success}</p>
            )}
            <button
